	...
	<table id="pending_duty_table" class="table table-striped table-bordered" border="1">
		...
		<tbody id="pending_table_body">
			...
			<tr id="<?php echo $pending_duty["pending_duty_id"];?>">
				...
				<td id="<?php echo $pending_duty["pending_duty_id"];?>_pending_duty_stuff" contenteditable="true"><?php echo $pending_duty["pending_duty_stuff"];?></td>
				<td id="<?php echo $pending_duty["pending_duty_id"];?>_pending_duty_substuff" contenteditable="true"><?php echo $pending_duty["pending_duty_substuff"];?></td>
