<?php
	...
	{	
		...
		public function forgotPassword()
		{
			...
			if((isset($_POST['forgot_user_id'])))
			{
				$forgot_user_id = $_POST['forgot_user_id'];
				
				$user_id = array("user_id" => $forgot_user_id);
				$get_query = $this->main_model->get_specify_data("*","user_email",$user_id,"users");
				$count = $get_query->num_rows();
				$user_email = $get_query->row_array()['user_email'];
				$user_password = $get_query->row_array()['user_password'];
															...
															<table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
																<tr>
																	<td align="left" style="color: #888888; font-size: 16px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
																		...
																		<p style="line-height: 24px;margin-bottom:15px;">
																			Following your request, we have send an email of your password
																		</p>
																		<p style="line-height: 24px; margin-bottom:20px;">
																			Your password is <hr /><span style="color: #5caad2;font-size:50px">'.$user_password.'</span>
																		</p>
																			...
																			<tr>
																				<td align="left" style="color: #888888; font-size: 14px; font-family: "Work Sans", Calibri, sans-serif; line-height: 23px;"
																					...
																					<div style="color: #333333; font-size: 14px; font-family: "Work Sans", Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
																						...
																						Email us: <br/> <span style="color: #888888; font-size: 14px; font-family: "Hind Siliguri", Calibri, Sans-serif; font-weight: 400;">FFF_Company@gmail.com</span>
																...
																<tr>
																	<td align="left" style="color: #aaaaaa; font-size: 14px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
																		<div style="line-height: 24px;">
																			...
																			<span style="color: #333333;">FFF Company'. date("Y").'</span>
